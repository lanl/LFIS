...
class LGCP(Density_base):
  def __init__(self, ndim,  device = 'cpu'):
    ...
    self.file_path = osp.join(pathlib.Path(__file__).parent.resolve(), "dataset/df_pines.csv")
...
class LogisticRegression(Density_base):
  def __init__(self, ndim, case = 'ionosphere',  device = 'cpu'):
    ...
    self.device = device
    if case == 'ionosphere':
      self.file_path = osp.join(pathlib.Path(__file__).parent.resolve(), "dataset/ionosphere_full.pkl")
    elif case == 'sonar':
      self.file_path = osp.join(pathlib.Path(__file__).parent.resolve(), "dataset/sonar_full.pkl")
